...
export BWA=bwa
export USEARCH="/data/gent/vo/001/gvo00142/software/usearch/usearch" #change to your USEARCH path
export MEDAKA_ENV_START="source /data/gent/vo/001/gvo00142/software/medaka/bin/activate" #change to your medaka venv path
export MEDAKA_ENV_STOP="deactivate"
export VSEARCH="/data/gent/vo/001/gvo00142/miniconda/envs/longread_umi/bin/vsearch" #change to your VSEARCH path
